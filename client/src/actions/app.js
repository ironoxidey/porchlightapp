...
export const getHostLocations = () => { //Host's locations as of Frebruary 3rd, 2022
	const hostLocations = [
		{
...
const sortStateCity = (a, b) => {
	...
	let hostFilteredLocations = hostProcessedLocations.filter((value, index, self) =>
		index === self.findIndex((t) => (
			t.city === value.city && t.state === value.state
		))
		);

	let	hostSortedLocations = hostFilteredLocations.sort((a, b) => (sortStateCity(a, b)));
