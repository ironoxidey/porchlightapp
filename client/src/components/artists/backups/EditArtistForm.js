...
const EditArtistForm = ({
    ...
    const formGroups = {
        ...
        socialLinks: [
            <FormLabel component="legend">
                Would you supply the social media and streaming profile links
                for {stageName}?
                <br />
                <small>
        ...
        tourVibe: [
            <FormLabel component="legend">
                Describe the content or vibe of this tour. Is this a faith-based
                show? Will your {medium} appeal specifically to a particular
                audience?{' '}
            </FormLabel>,
            [
                <Grid item>
        ...
        payoutPlatform: [
            ...
            >
                <Grid item>
                    ...
                    >
                        <InputLabel id="payoutPlatformLabel">
                            I prefer using
                        </InputLabel>
                        <Select
                            //variant="standard"
        ...
        overnight: [
            <FormLabel component="legend">
                ...
                {travelingCompanions ? ' and your traveling companions ' : ''}{' '}
                to stay overnight?
                <br />
                <small>
        ...
        hangout: [
            [
                ...
                >
                    ...
                    >
                        Our heart at Porchlight is to cultivate relationships
                        between artists and hosts. As such, we’d love to make
                        time for a little hangout either before or after the
                        show, just for you, your hosts, and maybe a couple
                        people interested in meeting with artists like you in a
        ...
        showSchedule: [
            <FormLabel component="legend">
                Schedules often get shifted by hosts or artists, but it’s really
                helpful to have a “proposed schedule” and tweak from there.
                Please edit the times below to best represent the schedule you
                propose.
            </FormLabel>,
            [
                <Grid item>
